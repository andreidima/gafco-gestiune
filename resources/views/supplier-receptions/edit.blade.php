                    ...
                    @if($canEditAll)
                        <select name="supplier_id" class="form-select" data-tom-select>
                            ...
                            @foreach($suppliers as $supplier)
                                <option value="{{ $supplier->id }}" data-search="{{ $supplier->cui }} {{ $supplier->registration_number }}" @selected((string) old('supplier_id', $reception->supplier_id) === (string) $supplier->id)>{{ $supplier->name }}{{ $supplier->active ? '' : ' (inactiv)' }}</option>
                            @endforeach
                        </select>
                    @else
            ...
            <section class="resource-form-section">
                ...
                @else
                    <x-reception-document-cards
                        ...
                        viewer-id="supplier-reception-edit-document-viewer"
                    />
                    <x-reception-document-viewer
                        :documents="$reception->documents"
                        id="supplier-reception-edit-document-viewer"
                    />
                @endif
            </section>
